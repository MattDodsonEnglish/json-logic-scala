...
class TestDeserializerConf extends AnyFlatSpec with Matchers {
  ...
  "createConf non unmarshaller object" should "throw an exception" in {
    ...
    val expectedMessage =
      """Found object is not a 'com.github.celadari.jsonlogicscala.deserialize.Unmarshaller' instance:
        |'com.github.celadari.jsonlogicscala.serialize.impl.MarshallerIntImpl$'""".stripMargin
  ...
  "createConf non singleton with singleton true in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """No singleton object found for: 'com.github.celadari.jsonlogicscala.deserialize.impl.UnmarshallerStringImpl'
        |Check if 'className' 'com.github.celadari.jsonlogicscala.deserialize.impl.UnmarshallerStringImpl' is correct and if """.stripMargin +
  ...
  "createConf non unmarshaller class" should "throw an exception" in {
    ...
    val expectedMessage =
      """Found class is not a 'com.github.celadari.jsonlogicscala.deserialize.Unmarshaller' instance:
        |'com.github.celadari.jsonlogicscala.serialize.impl.MarshallerDoubleImpl'""".stripMargin
    thrown.getMessage shouldBe expectedMessage
  }
  ...
  "createConf singleton with singleton false in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """No class found for: 'com.github.celadari.jsonlogicscala.deserialize.impl.UnmarshallerIntImpl'
        |Check if 'className' 'com.github.celadari.jsonlogicscala.deserialize.impl.UnmarshallerIntImpl' is correct and if 'singleton'""".stripMargin +
  ...
  "createConf wrong constructor argument names in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """Field error, check that no field in 'com.github.celadari.jsonlogicscala.deserialize.impl.UnmarshallerStringImpl2' is missing """ +
        """in 'string' property file.
          ...
          |Check if 'com.github.celadari.jsonlogicscala.deserialize.impl.UnmarshallerStringImpl2' class constructor requires arguments or if""".stripMargin +
