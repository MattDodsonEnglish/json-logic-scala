...
import com.github.celadari.jsonlogicscala.tree.types.DefaultTypes.{LONG_CODENAME, _}
...
trait TestMap extends AnyFlatSpec with Matchers {
  ...
  val mapArrBool: Map[String, Array[java.lang.Boolean]] = Map("plane" -> Array(true, false, true), "boat" -> Array(true, true, true), "submarine" -> Array(false, false, true))
  ...
  val mapArrDouble: Map[String, Array[java.lang.Double]] = Map("plane" -> Array(67d, 49d, 9d), "boat" -> Array(3d, 23d, 87d), "submarine" -> Array(7d, 23d, 24d))
  val mapArrFloat: Map[String, Array[java.lang.Float]] = Map("plane" -> Array(84f, 37f, 61f), "boat" -> Array(22f, 8f, 75f), "submarine" -> Array(2f, 945f, 24f))
  val mapArrString: Map[String, Array[java.lang.String]] = Map("plane" -> Array("Charizard", "Dragonite", "Gyarados"), "boat" -> Array("Obelisk", "Ra", "Slifer"), "submarine" -> Array("Griezmann", "Pogba", "Mbappe"))

  val mapMapBool: Map[String, Map[String, java.lang.Boolean]] = Map("airforce"-> Map("plane"-> true, "blimp"-> true), "navy" -> Map("boat" -> false, "submarine" -> true), "police" -> Map("car" -> false))
  val mapMapInt: Map[String, Map[String, java.lang.Integer]] = Map("airforce"-> Map("plane"-> 3, "blimp"-> 53), "navy" -> Map("boat" -> 56, "submarine" -> 78), "police" -> Map("car" -> 0))
  val mapMapLong: Map[String, Map[String, java.lang.Long]] = Map("airforce"-> Map("plane"-> 67L, "blimp"-> 45L), "navy" -> Map("boat" -> 9L, "submarine" -> 672L), "police" -> Map("car" -> 4L))
  val mapMapDouble: Map[String, Map[String, java.lang.Double]] = Map("airforce"-> Map("plane"-> 45d, "blimp"-> 23d), "navy" -> Map("boat" -> 76d, "submarine" -> 90d), "police" -> Map("car" -> 1d))
  val mapMapFloat: Map[String, Map[String, java.lang.Float]] = Map("airforce"-> Map("plane"-> 67f, "blimp"-> 1f), "navy" -> Map("boat" -> 89f, "submarine" -> 56f), "police" -> Map("car" -> 0f))
  val mapMapString: Map[String, Map[String, java.lang.String]] = Map("airforce"-> Map("plane"-> "I", "blimp"-> "in"), "navy" -> Map("boat" -> "love", "submarine" -> "walking"), "police" -> Map("car" -> "New York"))
